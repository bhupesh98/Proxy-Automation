...
ping $proxyServer.Split(':')[0] -n 1 -w 500 > $null 2>&1
...
if ($?) {
    ...
    if ($proxy) {
        ...
        [Environment]::SetEnvironmentVariable('http_proxy', $proxy, [System.EnvironmentVariableTarget]::Machine)
        [Environment]::SetEnvironmentVariable('ftp_proxy', $proxy, [System.EnvironmentVariableTarget]::Machine)
        [Environment]::SetEnvironmentVariable('NO_PROXY', 'localhost,127.0.0.1,10.96.0.0/12,192.168.59.0/24,192.168.49.0/24,192.168.39.0/24', [System.EnvironmentVariableTarget]::Machine)
    }
    # Enable proxy
    ...
    [Environment]::SetEnvironmentVariable('https_proxy', $null, [System.EnvironmentVariableTarget]::Machine)
    [Environment]::SetEnvironmentVariable('http_proxy', $null, [System.EnvironmentVariableTarget]::Machine)
    [Environment]::SetEnvironmentVariable('HTTP_PROXY', $null, [System.EnvironmentVariableTarget]::Machine)
    [Environment]::SetEnvironmentVariable('ftp_proxy', $null, [System.EnvironmentVariableTarget]::Machine)
    [Environment]::SetEnvironmentVariable('NO_PROXY', $null, [System.EnvironmentVariableTarget]::Machine)
